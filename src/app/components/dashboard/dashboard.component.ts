...
export class DashboardComponent {
  ...
  constructor(private router:Router,private customerService:CustomerService){
    if(localStorage.getItem("idCustomer")==undefined){
    ...
    else if(this.router.url=='/dashboard/support'){
      this.colorSelect5='rgb(47, 15, 55)'
      this.name5='construct'
    }
  ...
  colorSelect5='rgb(173, 168, 174)'
  name1='home-outline'
  name2='calculator-outline'
  name3='cash-outline'
  name4='log-out-outline'
  name5='construct-outline'
  colorSeleccion(n:number){
    ...
    this.colorSelect5='rgb(173, 168, 174)'
    if(n==1){
      this.colorSelect1='rgb(47, 15, 55)'
      this.name1='home'
    }
